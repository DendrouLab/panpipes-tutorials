...
Please download the input data that we have provided [here](). It's a random subset of the teaseq datasets that we also used for the `panpipes` paper.

You should find three `.h5ad` objects in ths
